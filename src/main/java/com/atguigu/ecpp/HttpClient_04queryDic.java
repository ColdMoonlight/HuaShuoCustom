 ...
 * @version 1.0
 */
public class HttpClient_04queryDic {
	...
	public static void main(String[] args) throws IOException {
		...
		String name = "Sales_channels" ; 
		String soapXML = getXML(token,name);
	...
	public static String getXML(String token,String name){
		String soapXML = "<?xml version=\"1.0\" encoding=\"utf-8\"?>"
		+"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
			+"<soap:Body>"
		    +"<queryDic xmlns=\"http://s7.vekinerp.com/ecpp_server.php/\">"
		    	+"<token>"+token+"</token>"
		    	+"<name>"+name+"</name>"
		    +"</queryDic>"
		  +"</soap:Body>"
