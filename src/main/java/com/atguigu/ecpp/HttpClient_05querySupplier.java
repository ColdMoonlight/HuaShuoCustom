 ...
 * @version 1.0
 */
public class HttpClient_05querySupplier {
	...
	public static void main(String[] args) throws IOException {
		...
		String startime = DateUtil.strTime14s();
		String endtime = DateUtil.strTime14s();
		Integer p = 1;
	...
	public static String getXML(String token,String startime,String endtime,Integer p){
		...
		+"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
			+"<soap:Body>"
		    +"<querySupplier xmlns=\"http://s7.vekinerp.com/ecpp_server.php/\">"
		    	+"<token>"+token+"</token>"
