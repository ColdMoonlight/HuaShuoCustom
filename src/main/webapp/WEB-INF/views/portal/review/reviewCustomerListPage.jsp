...
<head>
    ...
    <link rel="alternate" href="${ map.website_domain }/MlfrontReview/toReviewCustomer.html" hreflang="en-us" />
	<link rel="canonical" href="${ map.website_domain }/MlfrontReview/toReviewCustomer.html" />
	<!-- socail meta -->
	<meta name="twitter:site" content="@${ map.website_name }">
	<meta name="twitter:card" content="summary">
	<meta name="twitter:title" content="Customer Voice">
	...
	<meta property="og:title" content="Customer Voice">
	<meta property="og:url" content="${ map.website_domain }/MlfrontReview/toReviewCustomer.html">
