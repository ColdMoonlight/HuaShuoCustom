...
<head>
    ...
    <link rel="alternate" href="${ map.website_domain }/PortalHome/InsShowPage.html" hreflang="en-us" />
	<link rel="canonical" href="${ map.website_domain }/PortalHome/InsShowPage.html" />
	<!-- socail meta -->
	...
	<meta property="og:url" content="${ map.website_domain }/PortalHome/InsShowPage.html">
