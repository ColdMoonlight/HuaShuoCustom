...
<head>
    ...
    <link rel="alternate" href="${ map.website_domain }/MlfrontOrderList/searchTrackPage" hreflang="en-us" />
	<link rel="canonical" href="${ map.website_domain }/MlfrontOrderList/searchTrackPage" />
	<!-- socail media -->
	<meta property="og:type" content="website">
	<meta property="og:title" content="Search Track Info">
	<meta property="og:url" content="${ map.website_domain }/MlfrontOrderList/searchTrackPage">
